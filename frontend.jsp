...
<body>
  ...
  <div class="container my-4">
   ...
   <img src="front.jpg" alt=""> 
    ...
    <h3 style="padding-top: 4%;">Front-End Developer</h3>
    ...
    <h3 style="padding-top: 4%;">Main responsibilities</h3>
    <pre><p style="font-size: large;">
      *The main responsibility of the Front-End Developer is the User interface.

      *Simply put, create things that the user sees.

      *Tip: If you are curious about how to become a front-end developer, 
       you can read our How To Become a Front-End Developer Tutorial.
    </p></pre>

    <h3 style="padding-top: 4%;">Client Software (Front-End)</h3>
    <pre><p style="font-size: large;">
      ...
      <footer class="py-8">
        <div class="row">
          ...
          <div class="col-6 col-md-2 mb-3">
            <h5>Courses</h5>
            <ul class="nav flex-column">
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">FRONTEND DEVELOPMENT</a>
              </li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">BACKEND DEVELOPMENT</a>
              </li>
